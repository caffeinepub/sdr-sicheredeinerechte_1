...
export class Backend implements backendInterface {
    ...
    async changePassword(arg0: Profile, arg1: PasswordHash): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllLegalContent(): Promise<Array<LegalContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLegalContent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLegalContentById(arg0: bigint): Promise<LegalContent | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLegalContentById(arg0);
    ...
    async getMemberContent(): Promise<Profile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemberContent();
    ...
    async login(arg0: string, arg1: PasswordHash): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async register(arg0: string, arg1: PasswordHash): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_LegalContent]): LegalContent | null {

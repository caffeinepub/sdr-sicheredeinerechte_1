      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            ...
            children: "Diese Seite ist vorübergehend nicht verfügbar."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Wir führen derzeit Wartungsarbeiten durch. Bitte versuchen Sie es später erneut."
          }
        )
      ]
    }
...
const PaymentConfirmation = Record({
  "nickname": Nickname,
...
Service({
  ...
  "changePassword": Func([Profile, PasswordHash], [], []),
  "getAllLegalContent": Func([], [Vec(LegalContent)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getLegalContentById": Func([Nat], [Opt(LegalContent)], ["query"]),
  "getMemberContent": Func([], [Opt(Profile)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "login": Func([Text, PasswordHash], [Bool], ["query"]),
  "register": Func([Text, PasswordHash], [], []),
  "submitPaymentConfirmation": Func([Text, Text, Text], [], []),
  "getPaymentConfirmations": Func([], [Vec(PaymentConfirmation)], ["query"]),
  "getRegistrationCount": Func([], [Nat], ["query"])
});
